/**
 * ChatTarget — 指向 Direct Message 或 Channel 的内部可信引用。
 *
 * 供事件流、inbox、unread 游标与未来 Tasks 使用。
 * Agent 工具使用字符串 Message Target，并在工具边界转换（见 message-target.ts）。
 * 建模的是 chat 层「两种会话形态之一」这个概念，故住在 chat/，channel/ 单向依赖它。
 */

import type { ChatTarget } from "../contracts.js";

export type { ChatTarget } from "../contracts.js";
